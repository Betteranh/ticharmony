...
import { Boxes, ChevronRight, Search, Users as UsersIcon } from "lucide-react";
...
export function AssetsClientsView({
  tenants,
  labels,
}: {
        ...
        <div className="flex items-center gap-2 rounded-xl border border-hairline bg-surface p-2">
          <div className="flex flex-1 items-center gap-2 px-2">
            ...
            <input
              ...
              placeholder={labels.clientsSearchPlaceholder}
